...
#define NAME        "Hybrid 2.2+"
#define VERSION     "$Id: $"
#define AUTHOR      "Omega Team"
#define SUPPORTED   1

static int hybrid_startup();
static char	sid[20];
...
MODHEADER(NAME, VERSION, AUTHOR, MAKE_ABI(0,6,5),hybrid_startup, NULL);
static int hybrid_startup()
{
    int i;
    ...
    strlcpy (ProtocolInfo.name, "hybrid", sizeof(ProtocolInfo.name));
    ProtocolInfo.ts		= 1;
